...
public class CustomModeDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        propValueList = new javax.swing.JList<String>();
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        for (Object obj : propValueList.getSelectedValuesList()) {
            ((DefaultListModel) propValueList.getModel()).removeElement(obj);
        }
    }//GEN-LAST:event_removeButtonActionPerformed
    
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ((DefaultListModel<String>) propValueList.getModel()).addElement(newValueTextField.getText());
...
//    }
    ...
    private javax.swing.JList<String> propValueList;
    ...
    public MapMode getMapMode() {
        ...
        if (propValueList.getModel().getSize() == 0) {
            ...
            value = propValueList.getModel().getElementAt(0);
        } else {
            final StringBuilder patternBuilder = new StringBuilder("(");
            final int size = propValueList.getModel().getSize();
            for (int i = 0; i < size; i++) {
                patternBuilder.append(propValueList.getModel().getElementAt(i));
                if (i < size-1)
        ...
        if (countriesCheckBox.isSelected()) {
            ...
            if (value != null) {
                if (value.equals("SCALE"))
                    return new DiscreteScalingMapMode(name, 0, 10, 1);
