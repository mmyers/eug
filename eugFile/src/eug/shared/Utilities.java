...
public final class Utilities {
    public static final DecimalFormat POP_FORMATTER =
            new DecimalFormat("##,###,##0.000");
    private static final FileDateComparator SORT_BY_DATE =
    ...
    public static String formatPop(double pop) {
        return POP_FORMATTER.format(pop);
    }
    
    public static String findNewestFile(File dir) {
        final File[] list = dir.listFiles(/*EUG_FILTER*/);
    ...
    // serialized.
    private static final class FileDateComparator
            implements Comparator<File>, Serializable {
        private static final long serialVersionUID = 1L;
        public int compare(File f1, File f2) {
            final long f1mod = f1.lastModified();
            final long f2mod = f2.lastModified();
