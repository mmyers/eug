 ...
 * @author Michael
 */
public class CK3SaveGame extends ClausewitzSaveGame implements CK3DataSource {
    ...
    public CK3SaveGame(GenericObject root, String savePath, String mainPath, String modName) {
        super(root, savePath, mainPath, modName);
    }
    private CK3SaveGame(GenericObject root, String savePath, FilenameResolver resolver) {
        super(root, savePath, null, null);
    }
    
    public static CK3SaveGame loadSaveGame(String filename, String mainPath, String modName) {
        return new CK3SaveGame(EUGFileIO.load(filename), filename, mainPath, modName);
    }
    
    public static CK3SaveGame loadSaveGame(String filename, FilenameResolver resolver) {
        return new CK3SaveGame(EUGFileIO.load(filename), filename, resolver);
    }
