...
public class DiscreteScalingMapMode extends ProvincePaintingMode {
    ...
    private Color midColor = Color.YELLOW.darker();
    private Color minColor = Color.LIGHT_GRAY.brighter();
    ...
    protected void paintProvince(final Graphics2D g, int provId) {
        ...
        index = Math.max(0, Math.min(numColors-1, index));  // keep it in a valid range
