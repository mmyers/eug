...
public final class MapData {
    ...
    public MapData(final BufferedImage img, final int numProvs) {
        ...
        final java.util.Map<Integer[], Object> tmpBorders =
                new HashMap<Integer[], Object>(numProvs*32);    // use HashMap to avoid duplications
...
//        final int white = java.awt.Color.WHITE.getRGB();
        ...
        for (int y = 0; y < height; y++) {
            ...
            for (int x = 0; x < width; x++) {
                ...
                Integer[] points = new Integer[3];  // in (y, x1, x2) form
        ...
        // Now scan vertically for borders (straight horizontal borders weren't picked up in the first round)
